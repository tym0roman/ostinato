...
public:
    ...
    //oleh
    QRadioButton *rbL3Lldp_tlv;
    QRadioButton *rbL3Lacp;
    QRadioButton *rbL3Dcbx;
    QRadioButton *rbL3Stp;
    QRadioButton *rbL3Qinq;
    ...
    void setupUi(QDialog *StreamConfigDialog)
    {
        ...
        StreamConfigDialog->resize(634, 507);
        ...
        const QIcon icon = QIcon(QString::fromUtf8(":/icons/stream_edit.png"));
        ...
        page->setGeometry(QRect(0, 0, 592, 269));
        ...
        //oleh
        rbL3Lldp_tlv = new QRadioButton(gbL3Proto);
        rbL3Lldp_tlv->setObjectName(QString::fromUtf8("rbL3Lldp_tlv"));
        rbL3Lldp_tlv->setEnabled(false);

        gridLayout4->addWidget(rbL3Lldp_tlv, 3, 2, 2, 2);

        rbL3Lacp = new QRadioButton(gbL3Proto);
        rbL3Lacp->setObjectName(QString::fromUtf8("rbL3Lacp"));
        rbL3Lacp->setEnabled(false);

        gridLayout4->addWidget(rbL3Lacp, 3, 3, 2, 2);

        rbL3Dcbx = new QRadioButton(gbL3Proto);
        rbL3Dcbx->setObjectName(QString::fromUtf8("rbL3Dcbx"));
        rbL3Dcbx->setEnabled(false);

        gridLayout4->addWidget(rbL3Dcbx, 3, 1, 3, 2);

        rbL3Stp = new QRadioButton(gbL3Proto);
        rbL3Stp->setObjectName(QString::fromUtf8("rbL3Stp"));
        rbL3Stp->setEnabled(false);

        gridLayout4->addWidget(rbL3Stp, 3, 0, 2, 3);

        rbL3Qinq = new QRadioButton(gbL3Proto);
        rbL3Qinq->setObjectName(QString::fromUtf8("rbL3Qinq"));
        rbL3Qinq->setEnabled(false);

        gridLayout4->addWidget(rbL3Qinq, 4, 3, 3, 3);
        ...
        page_2->setGeometry(QRect(0, 0, 250, 135));
        ...
        const QIcon icon2 = QIcon(QString::fromUtf8(":/icons/arrow_up.png"));
        tbUp->setIcon(icon2);
        ...
        const QIcon icon3 = QIcon(QString::fromUtf8(":/icons/arrow_down.png"));
        ...
        const QIcon icon4 = QIcon(QString::fromUtf8(":/icons/delete.png"));
        ...
        //oleh
        QWidget::setTabOrder(rbL3Arp, rbL3Lldp_tlv);
        QWidget::setTabOrder(rbL3Lldp_tlv, rbL3Lacp);
        QWidget::setTabOrder(rbL3Lacp, rbL3Dcbx); // modifed
        QWidget::setTabOrder(rbL3Dcbx, rbL3Stp);
        QWidget::setTabOrder(rbL3Stp, rbL3Qinq);
        QWidget::setTabOrder(rbL3Qinq, rbL3Other);
...
"", 0, QApplication::UnicodeUTF8));
        ...
        //oleh
        rbL3Lldp_tlv->setText(QApplication::translate("StreamConfigDialog", "LLDP", 0, QApplication::UnicodeUTF8));
        rbL3Lacp->setText(QApplication::translate("StreamConfigDialog", "LACP", 0, QApplication::UnicodeUTF8));
        rbL3Dcbx->setText(QApplication::translate("StreamConfigDialog", "DCBX", 0, QApplication::UnicodeUTF8));
        rbL3Stp->setText(QApplication::translate("StreamConfigDialog", "STP", 0, QApplication::UnicodeUTF8));
        rbL3Qinq->setText(QApplication::translate("StreamConfigDialog", "QinQ", 0, QApplication::UnicodeUTF8));
