...
class Gmp_GroupRecord : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_group_address(::OstProto::Gmp_IpAddress* group_address);
  ...
  inline void set_allocated_aux_data(::std::string* aux_data);
...
inline void Gmp_GroupRecord::set_type(::OstProto::Gmp_GroupRecord_RecordType value) {
  assert(::OstProto::Gmp_GroupRecord_RecordType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void Gmp_GroupRecord::set_allocated_group_address(::OstProto::Gmp_IpAddress* group_address) {
...
inline void Gmp_GroupRecord::set_allocated_aux_data(::std::string* aux_data) {
  if (aux_data_ != &::google::protobuf::internal::kEmptyString) {
    delete aux_data_;
  }
  if (aux_data) {
...
inline void Gmp::set_allocated_group_address(::OstProto::Gmp_IpAddress* group_address) {
  delete group_address_;
  group_address_ = group_address;
  if (group_address) {
    set_has_group_address();
...
inline void Gmp::set_group_mode(::OstProto::Gmp_GroupMode value) {
  assert(::OstProto::Gmp_GroupMode_IsValid(value));
  set_has_group_mode();
  group_mode_ = value;
}
