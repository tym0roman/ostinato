...
inline void TextProtocol::set_encoding(::OstProto::TextProtocol_TextEncoding value) {
  assert(::OstProto::TextProtocol_TextEncoding_IsValid(value));
  set_has_encoding();
  encoding_ = value;
}
...
inline void TextProtocol::set_allocated_text(::std::string* text) {
  if (text_ != &::google::protobuf::internal::kEmptyString) {
    delete text_;
  }
  if (text) {
...
inline void TextProtocol::set_eol(::OstProto::TextProtocol_EndOfLine value) {
  assert(::OstProto::TextProtocol_EndOfLine_IsValid(value));
  set_has_eol();
  eol_ = value;
}
